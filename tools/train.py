...
def parse_args():
    ...
    # parser.add_argument('config',default=('configs/detection/ava/slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb.py'),help='train config file path')
    #log要放在哪
    parser.add_argument('--work-dir', help='the dir to save logs and models')
    #parser.add_argument('--work-dir',default=('tests/0425_log'),help='the dir to save logs and models')
    parser.add_argument(
        '--resume-from', help='the checkpoint file to resume from')
    parser.add_argument(
        '--validate',
        action='store_true',
        #啟用上面的default路徑，不用command輸入
        # default=True,
